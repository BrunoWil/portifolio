...
📍 Fortaleza – CE  
💡 Profissional motivado e focado no desenvolvimento full-stack de aplicações inovadoras e funcionais.  
🚀 Experiência com sistemas corporativos, soluções móveis, infraestrutura Cloud e práticas CI/CD.
...
- 🏢 **Controle e Monitoramento (Sistemas Corporativos)** – Desenvolvimento de sistemas corporativos para conferência de dados, processos e controle de estoques. *(Vue.js, Python, FastAPI)*  
- 📱 **Soluções Móveis** – Desenvolvimento de aplicativos móveis inovadores utilizando metodologias de resolução de problemas reais. *(Dart, Flutter, Firebase)*  
- ☁️ **Cloud & CI/CD (Infraestrutura e DevOps)** – Implementação de práticas DevOps buscando otimização de fluxo e garantia da segurança da informação. *(AWS, GitHub Actions, PostgreSQL)*  

**Projetos Anteriores:**  
- 🎮 **Jogo da Velha Distribuído** | 🐾 **AdotsPets** | 🌱 **Organic Plus**
...
- **IFCE (2026)** – Bacharelado em Engenharia de Computação
